...
static void cr_assert_ft_putstr_fd(char *s, int fd)
{
	char *out, *err;
...
Test(ft_putstr_fd, hello)
{
	cr_assert_ft_putstr_fd("Hello World!", 1);
}

Test(ft_putstr_fd, one_character)
{
	cr_assert_ft_putstr_fd("a", 1);
}

Test(ft_putstr_fd, empty_string)
{
	cr_assert_ft_putstr_fd("", 1);
}

Test(ft_putstr_fd, hello_stderr)
{
	cr_assert_ft_putstr_fd("Hello World!", 2);
}
